  ...
  public ArmStage2() {
    /* Factory default hardware to prevent unexpected behavior */
      ...
      m_ArmStageMotor2.configNeutralDeadband(0.001, EncoderConstants.kTimeoutMs);
		 ...
		 */
		  m_ArmStageMotor2.setSensorPhase(false);
		  m_ArmStageMotor2.setInverted(false);
		/*
      ...
      m_ArmStageMotor2.config_kD(EncoderConstants.kSlotIdx, EncoderConstants.kGains.kD, EncoderConstants.kTimeoutMs);
		...
		/* Set acceleration and vcruise velocity - see documentation */
		  m_ArmStageMotor2.configMotionCruiseVelocity(15000, EncoderConstants.kTimeoutMs);
		  m_ArmStageMotor2.configMotionAcceleration(6000, EncoderConstants.kTimeoutMs);
